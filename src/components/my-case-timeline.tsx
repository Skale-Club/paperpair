                ...
                {PHASES.map((phase, i) => {
                    ...
                    return (
                        <div key={phase.id} className="relative">
                            ...
                            {active && (
                                <div className="ml-3 mb-2 border-l-2 border-slate-200 pl-3 space-y-2">
                                        ...
                                        return (
                                            <div key={section.id}>
                                                <button
                                                    ...
                                                    className={`mr-2 w-full text-left rounded-lg border px-3 py-2 text-xs transition-colors flex items-center justify-between ${sectionActive
